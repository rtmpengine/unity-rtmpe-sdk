...
> **SDK Version:** `com.rtmpe.sdk 1.9.6`
> **Unity Version Required:** Unity 6 (6000.0 LTS) or later
...
| Requirement     | Detail                                    |
| --------------- | ----------------------------------------- |
| Unity           | Unity 6 (6000.0 LTS) or later             |
| .NET Standard   | 2.1                                       |
...
- [ ] SDK installed — `com.rtmpe.sdk 1.9.6` appears in Package Manager
...
*RTMPE SDK 1.9.6 — [Protocol Reference](protocol.md) — [API Reference](api/index.md)*
