...
//   • Object IDs are generated by combining the gateway session ID (high
//     32 bits) with a monotonic counter (low 32 bits). This ensures
//     uniqueness across clients without server coordination.
...
namespace RTMPE.Core
{
    ...
    public sealed class SpawnManager
    {
        ...
        /// High 32 bits: gateway session ID (ensures cross-client uniqueness).
